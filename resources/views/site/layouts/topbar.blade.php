<div class="logo-bar">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-4">
            <img src="{{ asset('assets/images/top_address/logo_top.png') }}" class="logo-image">
        </div>
                ...
                <div class="row">
                        ...
                        <a href="{{ route('contact') }}#location-map">
                          <div class="media">
                             <div class="media-left">
                               <img src="{{ asset('assets/images/top_address/location_icon.png') }}" class="media-object" style="width:30px">
                             </div>
                   ...
                   <div class="col-md-4">
                          <a href="//api.whatsapp.com/send?phone=8801872634967">
                            <div class="media">
                              <div class="media-left">
                                <img src="{{ asset('assets/images/top_address/whatsapp.png') }}" class="media-object" style="width:30px">
                              </div>
                              <div class="media-body">
              ...
              <div class="col-md-3 col-md-offset-1">
                @if(session()->has('user_mail'))
                  @if(session()->get('user_role') == 'user')
                    <a href="{{ route('schedule.create') }}" class="btn btn-danger btn-calculate" role="button">Portal</a>
                  @else
                    <a href="{{ route('schedule.list') }}" class="btn btn-danger btn-calculate" role="button">Portal</a>
                  @endif
                  <a href="{{ route('logout') }}" class="btn btn-danger btn-calculate" role="button">Logout</a>
                @else
                  <a href="{{ route('signin') }}" class="btn btn-danger btn-calculate" role="button">SIGN IN</a>
                  <a href="{{ route('signup') }}" class="btn btn-danger btn-calculate" role="button">SIGN UP</a>
                @endif
              </div>
           </div>
        </div>
