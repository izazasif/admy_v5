             ...
             <div class="row">
                 <div class="col-md-3 padding">
                     <div class="row  background-red">
                        ...
                        <div class="col-md-8">
                             <h4>OBD Platform</h4>
                             <p>The system automatically dials out calls to a list of mobile users provided by the telecom operator.</p>
                        </div>
                     </div>
                 </div>
                 <div class="col-md-3 padding">
                     <div class="row background-red">
                        <div class="col-md-4">
                            <img src="{{ asset('assets/images/banner_icon/bulk-sms-service.png') }}" class="plat-image">
                        </div>
                        <div class="col-md-8">
                             <h4>BULK SMS Service</h4>
                             <p>Use bulk SMS to raise brand awareness or just send SMS for your personal non-commercial needs.</p>
                        </div>
                     </div>
                 </div>
                 ...
                 <div class="col-md-3 padding">
                      <div class="row background-red">
                         <div class="col-md-4">
                             <img src="{{ asset('assets/images/banner_icon/digital-platform.png') }}" class="plat-image">
                         </div>
                         <div class="col-md-8">
                              <h4>DIGITAL Platform</h4>
                              <p>Digital platforms allow for companies to pursue and create new business models that connect buyers and sellers.</p>
                         </div>
                      </div>
                 </div>
                 ...
                 <div class="col-md-3 padding">
                     <div class="row background-red">
                        <div class="col-md-4">
                            <img src="{{ asset('assets/images/banner_icon/push-marketing.png') }}" class="plat-image">
                        </div>
                        <div class="col-md-8">
                             <h4>PUSH Marketing</h4>
                             <p>Push marketing is an interactive communication system, which pop-up on the handset’s screen & engage.</p>
                        </div>
                     </div>
                 </div>
             </div>
                     ...
                     <div class="flip-box">
                        <div class="flip-box-inner">
                           ...
                           <div class="flip-box-back">
                              ...
                              <p class="flip-back-text">Holistic analytics about the whole community and target market. </p>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-3">
                     <div class="flip-box">
                        <div class="flip-box-inner">
                           ...
                           <div class="flip-box-back">
                              <!-- <h2>AdMy</h2> -->
                              <p class="flip-back-text">Business growth escalation through huge subscriber base.</p>
                           </div>
                        </div>
                     </div>
                  </div>
                ...
                <div class="obd-heading">
                   <div class="row">
                       ...
                       <div class="col-md-8">
                          ...
                          <p class="second-p"><b>The main features of this system should be:</b> Self execution option for the customer should be easily configured (IVR system) and customized with 3rd party applications for different VAS services.</p>
                       </div>
                   </div>
                </div>
                <div class="detail">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                       <ul style="list-style-type:none">
                         <li>Supports Call Patching, that is it routes IVR call to a customer support executive.</li>
                         <li>Allows checking the quality of voice calls before initiating the dialling process.</li>
                         <li>Allows defining dialling policies to call a particular list of numbers daily, weekly or monthly.</li>
          ...
          <div class="row">
              <div class="col-md-5 col-md-offset-1">
                  ...
                  <div class="global-delivery" data-aos="zoom-in" data-aos-duration="1000">
                      ...
                      <p>Use bulk SMS to raise brand awareness or just send SMS for your personal non-commercial needs. Automated SMS mailling reaches recipients at the speed of 200-500 SMS per second on 800 networks in over 200 countries around the world.</p>
                  </div>
              </div>
              <div class="col-md-6">
                  <div class="titles">
                  ...
                  <div class="row">
                      <div class="col-md-10">
                          <h3 class="service-process text-center" data-aos="fade-right" data-aos-duration="1000"><b>Service Process</b></h3>
                          <img src="{{ asset('assets/images/push_sms_03/push-sms-service.png') }}" class="img-responsive" data-aos="zoom-out" data-aos-duration="1000">
                      </div>
                  </div>
              </div>
          </div>
              ...
              <div class="col-md-12">
                  ...
                  <div class="row">
                      ...
                      @foreach($push_sms as $sm)
                          <div class="col-md-3 text-center" data-aos="zoom-out" style="margin-left: 30px">
                              <div class="package">
          ...
          <div class="row">
              ...
              <div class="col-md-7">
                  ...
                  <div class="row">
                      <div class="col-md-10">
                          <h3 class="service-process text-center" data-aos="fade-right" data-aos-duration="1000"><b>Service Process</b></h3>
                          <img src="{{ asset('assets/images/bulk_sms_02/bulk-sms-infographic.png') }}" class="img-responsive" data-aos="zoom-out" data-aos-duration="1000">
                      </div>
                  </div>
              </div>
          </div>
    ...
    <div class="container-fluid">
       <div class="row">
           <div class="col-md-7 col-md-offset-1 image">
               ...
               <img src="{{ asset('assets/images/digital_platform/digital-platform.png') }}" class="img-responsive" data-aos="zoom-out">

           </div>
           <div class="col-md-10 col-md-offset-1 content-digital">
              <h5><b>Digital excellence require platform thinking. How does a digital version of your business look? We help you to create it through our expertise in architecture and digital platforms.</b></h5>

              <p>Key attributes for a digital enterprise include intentional and beautiful design, value for both customer and business, part of your ecosystem of value, delivering with speed and quality. We help modernize your legacy systems to better cope with the speed of technology change, making sure that you, securely, can  participate in new digital ecosystems with your data and APIs.</p>


              <h5><b>Our Services:</b></h5>
              <p>We are enabler as you create and update your digital platforms in, or outside of the cloud. We offer:</p>
           ...
           <div class="col-md-5 col-md-offset-1 content-digital-left">
              ...
              <h4><b>Cost per acquisition is also referred to as cost per action or CPA — but don’t get confused with diction, these three terms all mean the same thing!</b></h4>
           </div>
    ...
    <div class="modal-dialog modal-lg" style="margin-top: 120px">
      <div class="modal-content">
        <div class="modal-body">
          ...
          <a href="{{ route('signup') }}">
            <img src="{{ asset('assets/admy/image/popup3.jpg') }}" class="img-responsive" style="padding-top: 10px;">
          </a>
        </div>
