                ...
                <div class="distable">
                  ...
                  <div class="distable-row">
                    <div class="form-group distable-cell">
                      ...
                      <input style="position: inherit;" class="form-control input-sm daterangepicker" type="text" name="shpdaterange" placeholder="Choose Date Range" value="{{ session()->has('shpdaterange') ? session()->get('shpdaterange') : '' }}">
                    </div>
                    <div class="form-group distable-cell">
                      ...
                      <select class="form-control input-sm" id="shpack" name="shpack">
                        ...
                        @foreach($packs as $pack)
                          <option value="{{ $pack->id }}" {{ (session()->has('shpack') && session()->get('shpack') == $pack->id) ? 'selected' : '' }}>{{ $pack->name }}</option>
                        @endforeach
                      </select>
                    </div>
                    ...
                    <div class="distable-cell search-btns">
                      <a class="btn btn-sm btn-flat btn-warning" href="{{ route('pack.history.reset') }}">Reset</a>
                    </div>
                  </div>
            ...
            <table class="table table-bordered table-hover" style="margin-top:20px; margin-bottom:30px">
              ...
              <tr>
                ...
                <td class="text-center">
                  ...
                  @else
                    <span style="color:red"><b><i class="fa fa-times" aria-hidden="true"></i>&nbsp;Expired</b></span>
                  @endif
                </td>
              </tr>
              @endforeach
