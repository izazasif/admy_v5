      ...
      <div class="col-xs-12 col-sm-6">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Create OBD Pack</h3>
              ...
              <form method="POST" action="{{ route('pack.store') }}" enctype="multipart/form-data">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" step="0.01" min=0 class="form-control" name="unit_price" placeholder="Enter Unit Price" value="{{ old('unit_price') }}">
                  </div>
                  <div class="form-group">
