                            ...
                            <div class="distable">
                                ...
                                <div class="distable-row">
                                    <div class="form-group distable-cell">
                                        ...
                                        <input style="position: inherit;" class="form-control input-sm daterangepicker" type="text" name="shdaterange" placeholder="Choose Date Range" value="{{ session()->has('shdaterange') ? session()->get('shdaterange') : '' }}">
                                    </div>
                                    <!-- <div class="form-group distable-cell">
                                    ...
                                    <div class="form-group distable-cell">
                                        ...
                                        <select class="form-control input-sm" id="shcategory" name="shcategory">
                                            ...
                                            <option value="{{ $category->id }}" {{ session()->has('shcategory') && session()->get('shcategory') == $category->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group distable-cell">
                                        ...
                                        <input class="form-control input-sm" type="text" name="app_id" placeholder="Type App ID here.." value="{{ session()->has('app_id') ? session()->get('app_id') : '' }}">
                                    </div>

                                    <div class="form-group distable-cell">
                                        <label for="app_name">App Name</label>
                                        <input class="form-control input-sm" type="text" name="app_name" placeholder="Type App Name here.." value="{{ session()->has('app_name') ? session()->get('app_name') : '' }}">
                                    </div>

                                    <div class="form-group distable-cell">
                                        <label for="ussd_code">USSD Code</label>
                                        <input class="form-control input-sm" type="text" name="ussd_code" placeholder="Type USSD Code here.." value="{{ session()->has('ussd_code') ? session()->get('ussd_code') : '' }}">
                                    </div>
                                    ...
                                    <div class="form-group distable-cell">
                                        ...
                                        <select class="form-control input-sm" id="shstatus" name="shstatus">
                                            ...
                                            <option value="active" {{ session()->has('shstatus') && session()->get('shstatus') == 'active' ? 'selected' : '' }}>
                                                Delivered</option>
                                            <option value="inactive" {{ session()->has('shstatus') && session()->get('shstatus') == 'inactive' ? 'selected' : '' }}>
                                                Pending</option>
                                            <option value="-1" {{ session()->has('shstatus') && session()->get('shstatus') == '-1' ? 'selected' : '' }}>
                                                Rejected</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="distable-cell search-btns">
                                        <a class="btn btn-sm btn-flat btn-warning" href="{{ route('schedule.list.reset') }}">Reset</a>
                                    </div>
                                </div>
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-bordered table-hover" style="margin-top:20px; margin-bottom:30px">
                            ...
                            <tr>
                                ...
                                @if (session()->get('permission') != 'obd_viewer' && session()->get('permission') != 'obd_sms_viewer')
                                <td class="text-center">
                                    <button type="button" class="btn btn-primary btn-xs deliver_btn" data-toggle="modal" data-target="#exampleModal" data-id="{{ $schedule->id }}">
                                        <i class="fa fa-rocket" aria-hidden="true"></i> Deliver
                                    </button>
                                ...
                                <td class="text-center">
                                    ...
                                    <button type="button" class="btn btn-primary btn-xs deliver_btn" data-toggle="modal" data-target="#exampleModal_view{{ $schedule->id }}" data-id="{{ $schedule->id }}">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <!-- <input type="text" id='datetimepicker' class="form-control"
                                                                                                        ...
                                                                                                        required> -->
                                                        <input type="datetime-local" id="meeting-time" class="form-control" name="actual_delivery_time" value="" min="2020-12-07T00:00" max="2030-12-14T00:00">
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="sent_amount">Send Amount</label>
                                                        <input type="number" class="form-control" name="sent_amount" value="{{ $data->sent_amount ?? 'None' }}">

                                                    </div>
                                                    <div class="form-group">
                                                        <label for="sent_amount">Success Amount</label>
                                                        <input type="number" class="form-control" name="success_amount" value="{{ $data->success_amount ?? 'None' }}">

                                                    </div>
                                                    <div class="form-group">
                                                        <label for="sent_amount">Failed Amount</label>
                                                        <input type="number" class="form-control" name="failed_amount" value="{{ $data->failed_amount ?? 'None' }}">

                                                    </div>
                                                    <div class="form-group">
                                                        <label for="sent_amount">Subscribed Amount</label>
                                                        <input type="number" class="form-control" name="subscribed_amount" value="{{ $data->subscribed_amount ?? 'None' }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" id='datetimepicker1' class="form-control" name="actual_delivery_time" placeholder="Enter Actual Delivery Time" value="" required>
                        </div>
                        <div class="form-group">
                            <label for="sent_amount">Sent Amount</label>
                            <input type="number" class="form-control" name="sent_amount" placeholder="Enter Sent Amount" value="" required>
                        </div>
                        <div class="form-group">
                            <label for="success_amount">Success Amount</label>
                            <input type="number" class="form-control" name="success_amount" placeholder="Enter Success Amount" value="" required>
                        </div>
                        <div class="form-group">
                            <label for="failed_amount">Failed Amount</label>
                            <input type="number" class="form-control" name="failed_amount" placeholder="Enter Failed Amount" value="" required>
                        </div>
                        <div class="form-group">
                            <label for="subscribed_amount">Subscribed Amount</label>
                            <input type="number" class="form-control" name="subscribed_amount" placeholder="Enter Subscribed Amount" value="" required>
                        </div>
                    </div>
                    <!-- /.box-body -->
