                  ...
                  <div class="form-group distable-cell">
                    ...
                    <div class="form-group distable-cell">
                      ...
                      <select class="form-control input-sm" id="shcategory" name="shcategory">
                        ...
                        @foreach($categories as $category)
                          <option value="{{ $category->id }}" {{ (session()->has('shcategory') && session()->get('shcategory') == $category->id) ? 'selected' : '' }}>{{ $category->title }}</option>
                        @endforeach
                      </select>
                    </div>
                    ...
                    <div class="form-group distable-cell">
                      ...
                      <select class="form-control input-sm" id="shstatus" name="shstatus">
                        ...
                        <option value="active" {{ (session()->has('shstatus') && session()->get('shstatus') == 'active') ? 'selected' : '' }}>Delivered</option>
                        <option value="inactive" {{ (session()->has('shstatus') && session()->get('shstatus') == 'inactive') ? 'selected' : '' }}>Pending</option>
                      </select>
                    </div>
