                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="username"
                                                placeholder="Enter Username" value="{{ $adminDetail->username }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Email</label>
                                            <input type="email" class="form-control" name="email"
                                                placeholder="Enter Email" value="{{ $adminDetail->email }}" disabled>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="user_permission" id="user_permission">
                                                ...
                                                <option value="all"
                                                    {{ $adminDetail->permission == 'all' ? 'selected' : '' }}>
                                                    Super Admin</option>
                                                <option value="obd_creator"
                                                    {{ $adminDetail->permission == 'obd_creator' ? 'selected' : '' }}>
                                                    OBD Manager</option>
                                                <option value="obd_viewer"
                                                    {{ $adminDetail->permission == 'obd_viewer' ? 'selected' : '' }}>
                                                    OBD Viewer</option>
                                                <option value="sms_creator"
                                                    {{ $adminDetail->permission == 'sms_creator' ? 'selected' : '' }}>
                                                    Push SMS Manager</option>
                                                <option value="sms_viewer"
                                                    {{ $adminDetail->permission == 'sms_viewer' ? 'selected' : '' }}>
